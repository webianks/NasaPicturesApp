...
class PicturesListAdapter(private val list: List<NasaPicture>) : RecyclerView.Adapter<PicturesListViewHolder>() {

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): PicturesListViewHolder {
        val itemBinding = ItemListPictureBinding.inflate(LayoutInflater.from(parent.context), parent, false)
        return PicturesListViewHolder(itemBinding)
    }
